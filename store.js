...
$v(document).ready(function(){
	...
	$v("#efusion-search #efusion-input").find("input[class=v4sbox]").blur(function(){
		if($v("#efuefusionsion-search #efusion-input").find("input[class=v4sbox]").val() == "") {
...
//Footer
  ...
  /pages/shipping\">Shipping Information<\/a></li><li><a href=\"http://stores.ebay.com/The-Whole-Shebang-New-York/pages/returns\">Returns<\/a><\/li><li><a href=\"http://contact.ebay.com/ws/eBayISAPI.dll?FindAnswers&frm=284&requested=thewholeshebang2013=-1\">Contact Us<\/a><\/li><\/ul><\/div><div class=\"f-col2\"><span><\/span><h1>Store Newsletter<\/h1><div id=\"efusion-newsletter2\"><form action=\"http://my.ebay.com/ws/eBayISAPI.dll?AcceptSavedSeller&sellerid=salmaqualitygold&refid=store&ssPageName=STORE:HTMLBUILDER:SIMPLEPAGE\" method=\"post\"><div id=\"efusion-text2\"><div align=\"left\"><p>Add my Store to your Favorite and receive my email newsletters about new items and special promotions!<\/p><p> <\/p><br \/><input type=\"checkbox\" name=\"nlchxbox\" value=\"selectedMailingList_3800389\" checked=\"checked\">General Interest <\/div><div id=\"efusion-signup2\"><input name=\"submit\" type=\"submit\" class=\"btn-signup2\" value=\"Sign up\" width=\"auto\" height=\"auto\" /><\/div><\/div><\/form><\/div></div><div class=\"f-col3\"><span><\/span><h1>We Accept<\/h1><div id=\"f-payment\"><\/div><\/div><div class=\"f-col4\"><div id=\"efusion-copy\">Copyright &copy; " + d.getFullYear() +" All rights reserved.<\/div><div id=\"efusion-designedby\">Store Designed &amp; efusioneloped By<\/div><div id=\"efusion
